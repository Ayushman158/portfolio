 ...
 *
 * Figma, Framer and Claude use their real logo geometry. The Framer and Claude
 * paths come from simple-icons (CC0-1.0), filled with each product's own brand
 * colour rather than left monochrome.
 *
 * Illustrator uses Adobe's "Ai" lettermark, which is how that app actually
 * ships its icon rather than a stand-in for one.
 *
 * Codex keeps a lettermark: OpenAI's mark is not in the CC0 set under any slug,
 * so there is no accurate source for it here. Its blossom is distinctive enough
 * that a reconstruction would read as wrong rather than as shorthand, and a
 * wrong logo on a portfolio is worse than an honest initial. Drop in the
 * official SVG and this becomes a real mark.
 */
