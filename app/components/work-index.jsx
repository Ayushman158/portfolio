    ...
    <section className="mt-16" onMouseMove={onMove}>
      ...
      {showPreview && (
        <motion.div
          ...
          initial={false}
          animate={{
            opacity: activeItem?.img ? 1 : 0,
            scale: activeItem?.img ? 1 : 0.97,
          }}
          transition={{ duration: 0.25, ease: [0.22, 1, 0.36, 1] }}
        >
          {activeItem?.img && (
            <div className="w-[260px] overflow-hidden rounded-lg border border-rule bg-raised shadow-[0_18px_50px_-20px_rgba(0,0,0,0.45)]">
              <Image
                src={activeItem.img}
                alt=""
                width={activeItem.w}
